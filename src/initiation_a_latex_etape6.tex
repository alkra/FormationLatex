...
} % Citer la source : tu ne l'as pas fait toi-même
% Pour les logos
\newcommand{\Logos}[2]{%
\vspace{1cm}
\begin{center}
...
% Oui, l'ordre de chargement est une difficulté de TeX/LaTeX
...
% Mauvaise idée : http://tex.stackexchange.com/questions/71172/
