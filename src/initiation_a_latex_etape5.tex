...
% Très important les références, insiste bien dessus : donner un titre
% aux flottants et y faire systématiquement référence dans le corps de
% texte (à la section \ref{...}, dans la figure \ref{...}). Éviter les
% ci-contre, ci-dessous : tu n'es pas censé maîtriser ton style.
...
% Oui, ne te prends pas les pieds dans le tapis : le paquet pour
% algorithmes est assez compliqué, et il vaut mieux dire de potasser
% la doc que se lancer dans une grande explication ; je pense que ça
% dépasse une initiation de 2h.
...
% Avertis tes ouailles : $ se tape \$ (cf. tex.stackexchange si
% beaucoup de dollars et peu de maths : \catcode)

De la même façon, il est possible de séparer les formules mathématiques pour les rendre plus visibles :

% Les paragraphes doivent être séparés par une ligne vide ou de \par ;
% si tu commences à utiliser des paquets moins bien programmés tu vas
% le sentir passer.
