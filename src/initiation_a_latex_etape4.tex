...
% Tu as le droit de mettre des retour à la ligne avant et après les
% titres : plus lisible et plus sûr quand tu modifieras le style des
% titres
% Tu as le droit de folder (rappel d'écriture d'un fichier
% texte : hard-wrap à 72 caractères et sauter une ligne entre les
% paragraphes)
